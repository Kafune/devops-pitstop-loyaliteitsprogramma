...
- YML files gewijzigd voor toevoegen van Prometheus
...
- Juist gebruik maken van git doormiddel van principes (Feature branches gebruiken en pull requesten)
...
- Prometheus integratie met Slack onderzoek uitgevoerd
...
- Soort van leadship op mij genomen
- Samenwerken met teamleden verloopt goed
