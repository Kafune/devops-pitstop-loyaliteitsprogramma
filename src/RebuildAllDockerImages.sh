...
docker build -t ghcr.io/pitstop-dotnet-sdk-base:1.0 . -f dotnet-sdk-base-dockerfile

# Build the .NET runtime base image
docker build -t ghcr.io/pitstop-dotnet-runtime-base:1.0 . -f dotnet-runtime-base-dockerfile

# Build the .NET ASP.NET base image
docker build -t ghcr.io/hanaim-devops/pitstop-dotnet-aspnet-base:1.0 . -f dotnet-aspnet-base-dockerfile
